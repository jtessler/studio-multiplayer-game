...
export default class GameComponent extends React.Component {
  ...
  getSessionUserIds() {
    if (this.state && this.state.metadata && this.state.metadata.users) {
  ...
  getSessionCreatorUserId() {
    if (this.state && this.state.metadata && this.state.metadata.creator) {
  ...
  getSessionTitle() {
    if (this.state && this.state.metadata && this.state.metadata.title) {
